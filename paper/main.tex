...
\begin{enumerate}
  ...
  \item a decomposition of process evidence into \emph{record integrity}, \emph{temporal
        ...
        definition of \emph{unforgeability} and an account of its epistemic role as
        \emph{defeater reduction}---eliminating a specified class of provenance doubts
        rather than certifying the conduct itself;
