...
\title{Unforgeable Process Evidence:\\ A Complement to Reproducibility}
...
\date{Manuscript version 0.2.0 --- \today}
...
rationale for treating unforgeable process evidence as a support for scientific
truth-claims---complementing, not replacing, reproducibility---and we show that the
...
\begin{enumerate}
  \item a clear separation of \emph{reproducibility} (what was claimed) from
        ...
        argument that the latter is a distinct, complementary support for scientific
        truth-claims;
...
\emph{how} the claim was arrived at. We have argued that the second is a distinct,
complementary support for scientific truth-claims---not a replacement for reproducibility
but a partner to it, closing the gap that reproducibility, by construction, cannot see.
